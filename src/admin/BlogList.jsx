    ...
    <>
      ...
      <div style={{ padding: "40px", maxWidth: "1400px", margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "30px" }}>
          <h2 style={{ fontSize: "28px", fontWeight: "700" }}>Manage Blogs</h2>
          <button
        ...
        {blogs.length === 0 ? (
          <p style={{ textAlign: "center", fontSize: "18px", color: "#999", marginTop: "60px" }}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", backgroundColor: "white", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
              <thead>
                <tr style={{ backgroundColor: "#f5f5f5", borderBottom: "2px solid #ddd" }}>
                  ...
                  <th style={{ padding: "15px", textAlign: "left", fontWeight: "600" }}>Author</th>
                  <th style={{ padding: "15px", textAlign: "left", fontWeight: "600" }}>Profession</th>
              ...
              <tbody>
                {blogs.map((blog) => (
                  <tr key={blog.id} style={{ borderBottom: "1px solid #eee" }}>
                    ...
                    <td style={{ padding: "15px", fontWeight: "500" }}>{blog.author}</td>
                    <td style={{ padding: "15px", color: "#666" }}>{blog.profession}</td>
                    <td style={{ padding: "15px", color: "#666", fontSize: "14px" }}>{blog.date}</td>
                    <td style={{ padding: "15px", fontWeight: "500", maxWidth: "300px" }}>
