            ...
            <main className="index">
                <section className="container section-lg">
                    <section className="card animate-content">
                        ...
                        <p className="summary-paragraph">
                            Strong understanding of the <b>Software Testing Life Cycle (STLC)</b> and <b>Software Development Life Cycle (SDLC)</b> 
                             with hands-on experience in <b>Agile / Scrum environments</b>. Highly skilled in <b>test case design</b>, 
